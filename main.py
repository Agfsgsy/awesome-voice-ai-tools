...
app = FastAPI(
    title=APP_NAME,
    description="استوديو ابن الواقدي: توليد وإنتاج صوت عربي، حوار طبيعي متعدد المتحدثين، تبديل تلقائي للمفاتيح والمحركات، تحرير النص، المواعظ، المؤثرات والموسيقى والاستنساخ المصرح به.",
    version=APP_VERSION,
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
